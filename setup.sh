...
python train.py --train_data_pattern="gs://youtube8m-ml-us-east1/2/frame/train/train*.tfrecord,gs://youtube8m-ml-us-east1/2/frame/validate/validate*.tfrecord" --model=NetVLADModelLF --train_dir ~/yt8m/v2/models/frame/NetVLADModelLF --frame_features --feature_names='rgb,audio' --feature_sizes='1024,128' --batch_size=80 --base_learning_rate=0.0002 --netvlad_cluster_size=256 --netvlad_hidden_size=1024 --moe_l2=1e-6 --iterations=300 --learning_rate_decay=0.8 --netvlad_relu=False --gating=True --moe_prob_gating=True --pruning_hparams=name=NetVLADModelLF_pruning,begin_pruning_step=500,end_pruning_step=2000,target_sparsity=0.3,sparsity_function_begin_step=500,sparsity_function_end_step=2000 --max_step=300000 --export_model_steps=4000 --max_steps=300000 --export_model_steps=4000
